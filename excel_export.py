...
def create_excel_with_template(results: List[ParseResult], output_file: str):
    ...
    columns = [
        ...
        # Сведения об объектах (I-X) - расширено с новыми полями
        "Вид объекта недвижимости_obj",  # I
        "Кадастровый номер_obj",  # J
        "Наименование",  # K - НОВОЕ ПОЛЕ
        "Назначение",  # L
        "Площадь общая",  # M
        "Площадь застройки",  # N - НОВОЕ ПОЛЕ для сооружений
        "Протяжённость",  # O - НОВОЕ ПОЛЕ для сооружений
        "Форма собственности_obj",  # P
        "Кадастровая стоимость_obj",  # Q
        "Удельный показатель кадастровой стоимости",  # R
        "Количество этажей (в том числе подземных)",  # S
        "Количество подземных этажей",  # T
        "Материал стен",  # U
        "Завершение строительства",  # V
        "Ввод в эксплуатацию",  # W
        "Сведения о культурном наследии",  # X
    ]
    ...
    # I-X: "Сведения об объектах расположенных на земельных участках" (расширено до колонки X)
    ws.merge_cells('I1:X1')
    cell_i1 = ws['I1']
    ...
    headers_display = {
        ...
        "Наименование": "Наименование",  # НОВОЕ ПОЛЕ
        "Назначение": "Назначение",
        "Площадь общая": "Площадь общая",
        "Площадь застройки": "Площадь застройки",  # НОВОЕ ПОЛЕ
        "Протяжённость": "Протяжённость",  # НОВОЕ ПОЛЕ
