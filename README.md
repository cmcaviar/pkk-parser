...
- ✅ **Запуск прямо из Excel** (без командной строки!)
- ✅ **Standalone .exe приложение для Windows** (не требует Python!)

## 🚀 Выбор способа использования

**Не знаете с чего начать?** 👉 **[Сравнение всех способов](USAGE_OPTIONS.md)**

Парсер поддерживает 4 способа использования на любой вкус и уровень подготовки!

## 🖥️ Standalone приложение для Windows

**Самый простой вариант для пользователей!** Двойной клик на .exe → вводите номера → получаете Excel файл.
...
👉 **[Инструкция по сборке .exe](BUILD_WINDOWS.md)** (для разработчиков)
👉 **[Быстрый старт .exe](QUICKSTART_EXE.md)** (3 шага)
👉 **[Руководство пользователя](USER_GUIDE_EXE.md)** (для конечных пользователей)

## 📊 Работа из Excel

**Для продвинутых пользователей!** Вписываете номера в Excel → запускаете макрос → получаете результат в том же листе.

### Windows:
👉 **[Инструкция для Windows](EXCEL_GUIDE.md)**
👉 **[Быстрый старт (3 шага)](QUICKSTART_EXCEL.md)**

### macOS:
👉 **[Инструкция для Mac](EXCEL_MAC_GUIDE.md)** 🍎
👉 **[Быстрый старт на Mac](QUICKSTART_MAC.md)**
...
├── excel_integration.py    # Интеграция с Excel через xlwings
├── gui_app.py              # GUI приложение (для .exe)
...
📘 **Для Windows:** Смотрите подробную инструкцию в файле [WINDOWS_GUIDE.md](WINDOWS_GUIDE.md)
